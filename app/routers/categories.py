...
async def get_all_categories(db: Session = Depends(get_db)) -> list[CategorySchema]:
    """
...
async def create_category(category: CategoryCreate, db: Session = Depends(get_db)) -> CategorySchema:
    """
